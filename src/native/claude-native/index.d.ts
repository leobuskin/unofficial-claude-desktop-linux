...
export declare function keys(keyNames: Array<string>): void
/** Press or release a single key. */
export declare function key(keyName: string, action: string): void
/** Click, press, or release a mouse button. */
export declare function mouseButton(button: string, action: string, count?: number | undefined | null): void
/** Scroll the mouse wheel. */
export declare function mouseScroll(amount: number, direction: string): void
/** Move the mouse cursor to screen coordinates. */
export declare function moveMouse(x: number, y: number, smooth: boolean): void
/**
 * Get the current mouse cursor position.
 * TODO: Replace with wlr-layer-shell overlay for real compositor position.
 */
export declare function mouseLocation(): MousePosition
...
export declare function getAppInfoForFile(path: string): AppInfo | null
/** Check if a process with the given name is running. */
export declare function isProcessRunning(name: string): boolean
...
export declare class InputEmulator {
...
export declare class AuthRequest {
  ...
  start(url: string, scheme: string, handle: Buffer): void
  cancel(): void
}
